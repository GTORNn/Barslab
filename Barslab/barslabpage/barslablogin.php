...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id,password FROM admindata   WHERE email = ?");
...
<body class="bg-light">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form action="" method="post" class="form-control mt-5 p-4"
            style="height:auto; width:380px; box-shadow: rgba(0, 0, 0, 0) 
            0px 1px 2px 0px, rgba(0, 145, 255, 0) 0px 2px 6px 2px;">
            <div class="row">
               <a href="barslablogin.php" style="margin-left: 70px;">
                <img src="../images/logo3.png" alt="BarsLab Logo"
                 width="180px" height="auto">
               </a>
                <h5 class="text-center p-4" 
          style="font-weight: 700;">Admin Hesabına Giriş Yap</h5>
            </div>
            <div class="col-mb-3">
                <label for="email"><i 
            ...
            <div class="col mb-3 mt-3">
                <button type="submit" 
                  class="btn btn-dark bg-dark" style="font-weight: 600;color:white;">Giriş</button>
            </div>
